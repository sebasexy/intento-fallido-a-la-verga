...
public class CardViewAdapter extends RecyclerView.Adapter<CardViewAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(final ContactViewHolder contactViewHolder, int i) {
        try {
            ...
            try{
                if (Integer.parseInt(jsonSlashes.get(0).toString()) == ChecklistActivity.SLASHED) {
            ...
            try{
                if (Integer.parseInt(jsonSlashes.get(1).toString()) == ChecklistActivity.SLASHED) {
            ...
            try{
                if (Integer.parseInt(jsonSlashes.get(2).toString()) == ChecklistActivity.SLASHED) {
            ...
            try{
                if (Integer.parseInt(jsonSlashes.get(3).toString()) == ChecklistActivity.SLASHED) {
        ...
        contactViewHolder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mContext, ChecklistActivity.class);
...
//                            .makeSceneTransitionAnimation(mMainActivity).toBundle());
        ...
        contactViewHolder.mCardView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                mMainActivity.selectedChecklistPos = (int) v.getTag();
